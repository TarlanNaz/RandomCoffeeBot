...
export const bot = new Bot(Deno.env.get("BOT_TOKEN") || "7534081607:AAGMH2AeyQpmlfDGsiBQGRKckZ1l40dF7Nw"); // export нужен, чтобы воспользоваться ботом в другом файле
